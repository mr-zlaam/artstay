...
export const logInUserSchema = z.object({
  username: z
    ...
    .max(450, { message: "username can be at most 450 characters long." }),
  password: z.string({ message: "email is required!!" }).min(3, { message: "email must be at least 3 characters long." })
});
